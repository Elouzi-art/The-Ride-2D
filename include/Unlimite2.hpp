#ifndef Unlimite2_HPP
#define Unlimite2_HPP
#include <SDL.h>
#include <SDL_ttf.h>
#include <vector>
#include <string>
...
{
public:
    GameMode12(SDL_Window* win, SDL_Renderer* rend);
    ~GameMode12();
    void handleEvents();
    void update();
    void render();
    ...
    void generateObstacle(M22_Obstacle &ob);
...
private:
    ...
    std::vector<M22_Obstacle> obstacles;    
    int level;
    int score = 0;
